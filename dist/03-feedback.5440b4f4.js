...
function onFormSubmit(event) {
    ...
    if (email.value === "" || message.value === "") alert("Please provide information for all fields!");
    else {
...
formElement.addEventListener("input", (0, _lodashThrottleDefault.default)(onFormInput, 500));
